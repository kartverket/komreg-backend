...
class ReguleringValidationTest : AnnotationSpec() {
    ...
    fun `Fylkesdeling må inneholde transformasjoner for dens kommuner`() {
            ...
            EndringDTO(
                ...
                transformasjoner = listOf(
                    FylkeTransformasjonDTO(
                        fylkesnummer = FraEnTilMangeDTO(
                            fra = "01", til = listOf("02", "03")
                        ),
                    ),
                ),
            ),
        ...
        val regulering = Regulering(
            "regId", "regulering med feil", LocalDate(2024, 1, 1), endringer
        )
            ...
            EndringDTO(
                ...
                transformasjoner = listOf(
                    KommuneTransformasjonDTO(
                        fylkesnummer = FraEnTilMangeDTO(
                            fra = "01", til = listOf("01")
                        ),
                        kommuneløpenummer = FraEnTilMangeDTO(
                            fra = "01", til = listOf("02", "03")
                        ),
                    ),
                ),
            ...
            EndringDTO(
                ...
                transformasjoner = listOf(
                    ...
                    MatrikkelenhetTransformasjonDTO(
                        fylkesnummer = FraTilDTO(
                            fra = "01", til = "01"
                        ),
                        kommuneløpenummer = FraTilDTO(
                            fra = "01", til = "02"
                        ),
                        gårdsnummer = FraTilDTO(
                            fra = "01", til = "01"
                        ),
                    ),
                    ...
                    VegTransformasjonDTO(
                        fylkesnummer = FraEnTilMangeDTO(
                            ...
                            fra = "01", til = listOf("02")
                        ), adressekode = FraTilDTO(
                            fra = "01", til = "01"
                        )
                    ),
                ),
    ...
    fun `Vegendring skal inneholde transformasjon av vegadresse, returnerer feil dersom dette mangler`() {
        ...
        val error = mutableMapOf<String, List<ErrorType>>(
