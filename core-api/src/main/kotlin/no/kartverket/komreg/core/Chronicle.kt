...
inline fun <L, E, A, Lin : @UnsafeVariance L, Ein : @UnsafeVariance E, B> Chronicle<L, E, A>.flatMap(f: (A) -> Chronicle<Lin, Ein, B>): Chronicle<L, E, B> =
    when (this) {
...
inline fun <L, E, A, B, C, R> productMap(
    fa: Chronicle<L, E, A>,
    fb: Chronicle<L, E, B>,
    fc: Chronicle<L, E, C>,
...
inline fun <L, E, A, B, C, D, R> productMap(
    fa: Chronicle<L, E, A>,
    fb: Chronicle<L, E, B>,
    fc: Chronicle<L, E, C>,
    fd: Chronicle<L, E, D>,
...
inline fun <L, E, A, B, C, D, E_, R> productMap(
    fa: Chronicle<L, E, A>,
    fb: Chronicle<L, E, B>,
    fc: Chronicle<L, E, C>,
    fd: Chronicle<L, E, D>,
...
inline fun <L, E, A, B, C, D, E_, F, R> productMap(
    fa: Chronicle<L, E, A>,
    fb: Chronicle<L, E, B>,
    fc: Chronicle<L, E, C>,
    fd: Chronicle<L, E, D>,
